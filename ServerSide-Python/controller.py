...
def person_detail():
        """Return data of person and template person_datail.
...
def persona_detail_update():
        """Return template person_detail
           and data of the updated person.
        """
        ...
        """Delete de name and last_name old
           and add the new data of the selected
           person.
           Depending on id.
        """
                    
        return render_template ('person_detail.html', value=("Updated Person: "+ "(" + p.id_person +" - "+ p.name + " - "+ p.last_name + ")"))
...
def delete_person(id):
        ...
        for i in model:
            if i.id_person == id:
                temp = i
                model.remove(i)
        """Delete data of a selected person.
           Depending on id.
        """
        return render_template ('person_detail.html', value=("Deleted Person: "+ "(" + temp.id_person +" - "+temp.name + " - "+ temp.last_name + ")"))
